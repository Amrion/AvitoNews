...
const HeadNews = ({title, url, by, time}) => {
    return (
        <div className="head">
            <div className='title'> {title} </div>
            <div className='url'> Прочитать полностью статью можно
                <a target='_blank' className='url__href'  rel="noreferrer" href={url}> здесь! </a>
            </div>
            <div className="svg-items">
                <div className="svg-items__name">
                    <svg className='svg-news' viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
                        <title/>
                ...
                <div className="svg-items__time">
                    <svg className='svg-news' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <g>
